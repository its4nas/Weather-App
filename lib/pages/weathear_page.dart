              ...
              child: Column(
                children: [
                  ...
                  Align(
                    ...
                    child: Text('${_temperature}°C', style: TextStyle(color: Colors.black, fontSize: 80, fontWeight: FontWeight.bold),),
                  ),
                  Row(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text('${_tempMax}°C', style: TextStyle(color: Colors.black, fontSize: 20, fontStyle: FontStyle.italic),),
                      const Icon(Icons.arrow_downward, color: Colors.black,),
                      Text('${_tempMin}°C', style: TextStyle(color: Colors.black, fontSize: 20, fontStyle: FontStyle.italic),),
                    ],
                  ),
